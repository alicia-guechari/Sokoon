"""
Django settings for Sokoon project.
...
SECRET_KEY = 'django-insecure-wrm*vc$jwd+)_d$8ac#qb-#^6ux##a%de@9a)i2gwgzbp9exn^'
...
WSGI_APPLICATION = 'Sokoon.wsgi.application'
